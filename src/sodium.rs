...
impl Sodium {
    ...
    /// # Returns
    /// Returns a [`CryptoKey`].
    pub fn crypto_secretstream_keygen(self) -> CryptoKey {
    ...
    /// }
    /// ```
    pub fn crypto_secretstream_init_push(self, key: CryptoKey) -> CryptoSecretStreamPush {
    ...
    ///  - `key`: [`CryptoKey`], the decryption key.
    ///
    /// # Returns
